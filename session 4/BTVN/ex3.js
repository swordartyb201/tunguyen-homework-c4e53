...
for(let i=0; i< hits.length; i++ ){
    ...
    console.log(hit.salaryMax)
    // console.log(hit.benefits)
    const benefits = hit.benefits
    console.log(benefits)
    for(let j=0; j< benefits.length; j++ ){
        console.log(benefits[j])
        console.log(benefits[j].benefitIconName)
        console.log(benefits[j].benefitName)
...
// //De truy cap vao tung value cua object -> phai truy cap thong qua key ()
...
// const randomArr = [1,2,3,4,5,6,4545,2,5,1];
...
// //Arr thi cac phan tu co chi so bat dau tu 0 -> arr.length-1
// //
...
// let lastElement = randomArr[randomArr.length -1];

// randomArr[randomArr.length-1] = 123
